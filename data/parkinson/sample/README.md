...
## Files
- `parkinson_sample_100.csv` - CSV format with headers
- `parkinson_sample_100.npz` - NumPy compressed format
...
# Load CSV
df = pd.read_csv('parkinson_sample_100.csv')

# Load NPZ
data = np.load('parkinson_sample_100.npz')
X, y = data['X'], data['y']
```
