...
## Files
- `autism_sample_100.csv` - CSV format with headers
- `autism_sample_100.npz` - NumPy compressed format
...
# Load CSV
df = pd.read_csv('autism_sample_100.csv')

# Load NPZ
data = np.load('autism_sample_100.npz')
X, y = data['X'], data['y']
```
