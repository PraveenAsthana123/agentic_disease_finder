...
## Files
- `epilepsy_sample_100.csv` - CSV format with headers
- `epilepsy_sample_100.npz` - NumPy compressed format
...
# Load CSV
df = pd.read_csv('epilepsy_sample_100.csv')

# Load NPZ
data = np.load('epilepsy_sample_100.npz')
X, y = data['X'], data['y']
```
