...
## Files
- `schizophrenia_sample_100.csv` - CSV format with headers
- `schizophrenia_sample_100.npz` - NumPy compressed format
...
# Load CSV
df = pd.read_csv('schizophrenia_sample_100.csv')

# Load NPZ
data = np.load('schizophrenia_sample_100.npz')
X, y = data['X'], data['y']
```
