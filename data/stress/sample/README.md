...
## Files
- `stress_sample_100.csv` - CSV format with headers
- `stress_sample_100.npz` - NumPy compressed format
...
# Load CSV
df = pd.read_csv('stress_sample_100.csv')

# Load NPZ
data = np.load('stress_sample_100.npz')
X, y = data['X'], data['y']
```
