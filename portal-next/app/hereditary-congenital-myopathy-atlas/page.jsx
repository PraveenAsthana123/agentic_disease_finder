...
const GENE_COLORS = {
  RYR1:    '#b71c1c',  // deep red — MHS anaesthesia emergency / CCD
  MYH7:    '#1565c0',  // deep blue — Laing distal + DCM cardiac dual
  ACTA1:   '#4a148c',  // deep purple — NEM3 nemaline rods de novo
  NEB:     '#1b5e20',  // dark green — NEM2 largest gene ankle contractures
  SELENON: '#e65100',  // deep orange — RSMD1 rigid spine no cardiac
  MTM1:    '#880e4f',  // dark pink — XLMTM most severe gene therapy
  DNM2:    '#006064',  // dark teal — CNM3 GTPase neuropathy overlap
  BIN1:    '#37474f',  // dark slate — CNM2 AR T-tubule milder
};

const GENE_DISEASE = {
  RYR1:    'AD/AR CCD/MmD/MHS1 — Ryanodine Receptor 1 — 5037aa — 19q13.2 — ANAESTHESIA-EMERGENCY Volatile Agents + Succinylcholine CI — Dantrolene IV Mandatory — Central Cores on Biopsy — Extraocular Spared',
  MYH7:    'AD Laing Distal Myopathy MPD1 — Slow Beta-Myosin Heavy Chain — 1935aa — 14q11.2 — CARDIAC-SURVEILLANCE-MANDATORY Annual ECG+Echo — DCM/LVNC Same Gene — Foot Drop Great Toe Extensor — Hyaline Body Myopathy',
  ACTA1:   'AD(70%deNovo)/AR NEM3 — Alpha-Skeletal Actin — 377aa — 1q42.13 — Nemaline Rods Pathognomonic — RESPIRATORY-SURVEILLANCE-MANDATORY — Neonatal Critical 30% — Facial Weakness — De Novo Germline Mosaicism',
  NEB:     'AR NEM2 — Nebulin LARGEST-HUMAN-GENE — 6669aa — 2q23.3 — Nemaline Rods + Ankle Contractures — MLPA-TRIPLICATE-MANDATORY Exons82-105 — Mild Respiratory — 80% Ambulatory — 25% Sibling Risk',
  SELENON: 'AR RSMD1/MmD — Selenoprotein N — 590aa — 1p36.11 — RIGID-SPINE-PATHOGNOMONIC — Scoliosis Early — NO-CARDIAC KEY-DDx-EMD-LMNA — Early Respiratory NIV — Selenium-Dependent Enzyme',
  MTM1:    'XLR XLMTM — Myotubularin PI3P-Phosphatase — 603aa — Xq28 — MOST-SEVERE Congenital Myopathy — High Neonatal Mortality 70% — Ventilator Dependent 85% — Ophthalmoplegia+Ptosis — Cognition NORMAL — Gene Therapy Aspiro',
  DNM2:    'AD CNM3/CMT-DIB — Dynamin-2 GTPase — 870aa — 19p13.2 — Central Nuclei + Hub-Spoke NADH — R465W Most Severe — Neuropathy Overlap CMT 40% — NCS Mandatory — Ophthalmoplegia Variable',
  BIN1:    'AR(typical)/ADrare CNM2 — Amphiphysin-2 BAR-Domain — 452aa — 2q14.3 — T-tubule Biogenesis — Milder Than MTM1 — 80% Ambulatory — NO-Cardiac Typically — 25% Sibling Risk AR',
};
...
export default function HCongenitalMyopathyAtlasPage() {
  ...
  useEffect(() => {
    const base = `${API}/api/hereditary-congenital-myopathy-atlas`;
    Promise.all([
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: 24 }}>
          <h1 style={{ color: '#f1f5f9', fontSize: 22, fontWeight: 800, margin: 0 }}>
            🧬 Hereditary Congenital Myopathy Atlas
          </h1>
          <p style={{ color: '#64748b', fontSize: 13, margin: '4px 0 0' }}>
            RYR1 · MYH7 · ACTA1 · NEB · SELENON · MTM1 · DNM2 · BIN1 — 320 Patients (8×40, Seeds 1726–1733)
          </p>
        </div>
