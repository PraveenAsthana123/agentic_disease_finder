...
const ACCENT5 = '#4a148c';   // deep purple — molecular biology / PEX12 catalytic mechanism
...
function OverviewTab({ data }) {
  ...
  return (
    <div>
      ...
      />
      <Alert
        text={`ℹ PEX12 = PRIMARY CATALYTIC subunit of the PEX2–PEX10–PEX12 RING E3 ubiquitin ligase complex (strongest autonomous E3 activity of the three). PEX12 drives POLYUBIQUITINATION of PEX5 (QC degradation), complementing PEX2 monoubiquitination (recycling). PEX12 LOF = single catalytic arm failure (PEX10 scaffold partially intact — unlike PEX10 LOF which collapses entire trimer). Biochemically identical to PEX1/PEX2/PEX6/PEX10-ZSD. ~3–5% of all PBD-ZSD; ~40–60 cases worldwide 2026. COMPLETES the PEX2–PEX10–PEX12 RING E3 triad.`}
        variant="info"
      />
      ...
      <SectionCard title="Disease Summary — PEX12 / Zellweger Spectrum Disorder (ZSD)" borderColor={ACCENT}>
      ...
      <div className="row">
        <div className="col-md-6">
          <SectionCard title="Clinical Profile" borderColor={ACCENT4}>
            ...
            <PctBar label="NALD (intermediate — null/partial)" pct={d.nald_pct} color={ACCENT3} />
            <PctBar label="IRD (attenuated — Gly271Asp/mild)" pct={d.ird_pct} color={ACCENT} />
      ...
      <SectionCard title="PEX12 Catalytic Mechanism — Primary E3 Subunit vs PEX2 and PEX10" borderColor={ACCENT5}>
        <div className="row small">
          <div className="col-md-4">
            <p className="fw-bold mb-1" style={{ color: ACCENT5 }}>PEX12 — Primary Catalytic</p>
            <ul className="mb-0">
              <li>RING finger: strongest autonomous E3 activity</li>
              <li>Drives PEX5 POLYUBIQUITINATION (QC pathway)</li>
              <li>Two TMDs: anchor in peroxisomal membrane</li>
              <li>PEX12 LOF = one catalytic arm fails</li>
              <li>PEX10 scaffold partially intact (PEX10-PEX2 preserved)</li>
            </ul>
          </div>
          <div className="col-md-4">
            <p className="fw-bold mb-1" style={{ color: ACCENT4 }}>PEX2 — Secondary Catalytic</p>
            <ul className="mb-0">
              <li>RING finger: weaker isolated E3 activity</li>
              <li>Drives PEX5 MONOUBIQUITINATION (recycling)</li>
              <li>PEX2 LOF = recycling arm fails</li>
              <li>PEX10-PEX12 scaffold partially preserved</li>
              <li>Both PEX2 + PEX12 LOF → identical phenotype</li>
            </ul>
          </div>
          <div className="col-md-4">
            <p className="fw-bold mb-1" style={{ color: ACCENT3 }}>Common Outcome (All 3 LOF)</p>
            <ul className="mb-0">
              <li>PEX5 cannot be ubiquitinated (mono or poly)</li>
              <li>PEX5 permanently trapped in membrane</li>
              <li>ALL peroxisomal matrix import fails</li>
              <li>Biochemically identical to PEX1/PEX6-ZSD</li>
            </ul>
          </div>
        </div>
        <div className="mt-2 small">
          <Badge text="p.Gly271Asp" color={ACCENT5} /> Partial-function RING allele → some residual E3 activity → enables IRD phenotype (20% IRD PEX12 — similar to PEX2 20%; less than PEX10 25% due to different partial-function allele position).
        </div>
      </SectionCard>
...
function PatientsTab({ data }) {
  ...
  return (
    <div>
      <Alert
        text="ℹ ZSD SPECTRUM (PEX12): null/null → ZS (30%) · null/p.Gly271Asp → NALD (45%) · p.Gly271Asp/mild → IRD (20% — similar to PEX2-ZSD 20%, less than PEX10 25%) · Atypical (5%). PEX12 has p.Gly271Asp partial-function RING allele. No founder hypomorphic allele → spectrum skewed severe. Biochemically identical to PEX1/PEX2/PEX6/PEX10-ZSD; only NGS panel distinguishes."
        variant="info"
      />
      <h6 className="fw-bold mb-3" style={{ color: ACCENT }}>PEX12-ZSD Phenotypic Classes — 4 Classes (40 Patients)</h6>
      {etiologies?.map((e, i) => (
            ...
            <div className="row small">
              ...
              <div className="col-md-6">
                ...
                <div className="d-flex gap-2 flex-wrap mt-1">
                  ...
                  {!e.ert_available && <Badge text="No ERT (membrane RING protein)" color="#888" />}
                </div>
              </div>
            </div>
...
function DefinitionsTab({ data }) {
  ...
  return (
    <>
      ...
      <SectionCard title="Differential Diagnosis (vs PEX1/PEX2/PEX6/PEX10/ABCD1/PHYH/RCDP/Mito)" borderColor={ACCENT3}>
        <div className="table-responsive">
          <table className="table table-sm">
...
// ── Main Component ────────────────────────────────────────────────────────────
export default function PEX12Page() {
  ...
  useEffect(() => {
    if (tab >= 1 && tab <= 3) {
      fetch(`${API}/api/pex12/breakdown`).then(r => r.json()).then(setBreakdown).catch(() => {});
    }
    if (tab === 4) {
      fetch(`${API}/api/pex12/definitions`).then(r => r.json()).then(setDefinitions).catch(() => {});
    }
  }, [tab]);
    ...
    <div className="container-fluid py-4" style={{ maxWidth: 1200 }}>
      <div className="mb-4">
        <h2 className="fw-bold mb-1" style={{ color: ACCENT }}>
          PEX12 Epilepsy — Zellweger Spectrum Disorder (ZSD)
        </h2>
        <p className="text-muted small mb-2">
          PEX12 (17q12) · RING finger E3 ubiquitin ligase — PRIMARY CATALYTIC subunit (359 aa) · PEX2–PEX10–PEX12 RING complex ·
          PEX12 = strongest autonomous E3 activity — drives PEX5 polyubiquitination (QC) ·
          AR biallelic LOF · p.Arg180* (most frequent null) · p.Gly271Asp (partial-function RING → IRD-enabling) ·
          ~3–5% of all PBD-ZSD · ~40–60 cases worldwide 2026 ·
          ZS 30% · NALD 45% · IRD 20% · Atypical 5% ·
          Biochemically identical to PEX1/PEX2/PEX6/PEX10-ZSD — only NGS panel distinguishes ·
          ...
          COMPLETES the PEX2–PEX10–PEX12 RING E3 triad
        </p>
