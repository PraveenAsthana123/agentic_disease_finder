...
const COLOR = '#4a0072';   // deep purple-violet — PD-module ND4-face triad / B22 scaffold
const LIGHT = '#f3e5f5';
  ...
  return (
    <>
      <div className="row g-3 mb-4">
        ...
        <KPI label="Also known as"     value="B22 / PD-module"     color={COLOR} />
      ...
      <SectionCard title="📊 Feature Frequencies (40-patient cohort, seed-643)">
...
function PatientsTab({ data }) {
  ...
  return (
    <>
      ...
      <SectionCard title="🗂 Patient Cohort (40 patients, seed-643)">
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function NDUFB8Page() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`${API}/api/ndufb8/overview`).then(r => r.json()),
      fetch(`${API}/api/ndufb8/breakdown`).then(r => r.json()),
      fetch(`${API}/api/ndufb8/definitions`).then(r => r.json()),
  ...
  return (
    <div className="container-fluid py-4">
      <div className="mb-4 p-3 rounded" style={{ background: COLOR, color: '#fff' }}>
        <h4 className="mb-1 fw-bold">&#x1f9ec; NDUFB8 — Leigh Syndrome Isolated Complex I Deficiency</h4>
        <div className="small opacity-90">
          CI-Leigh · PD-Module B22 1-TM-Helix ND4-Face Triad (NDUFB4-NDUFB6-NDUFB8) ·
          20.9 kDa · 186 aa precursor · 10q23.2 · OMIM Gene *602140 · AR biallelic · Isolated CI 5–20% · CII/CIII/CIV NORMAL
        </div>
      </div>
