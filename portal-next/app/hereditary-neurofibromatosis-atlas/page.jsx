...
const SLUG = 'hereditary-neurofibromatosis-atlas';
const TABS = ['Overview', 'Gene Table', 'Clinical Atlas', 'Definitions'];

const GENE_COLORS = {
  'NF1':     '#b71c1c',  // deep red       — NF Type 1; 1:3000; café-au-lait; MPNST
  'NF2':     '#1565c0',  // deep blue      — NF Type 2; bilateral VS; merlin
  'SMARCB1': '#2e7d32',  // deep green     — Schwannomatosis-2; AT/RT; INI1 loss
  'LZTR1':   '#e65100',  // deep orange    — Schwannomatosis-1; bidirectional AD/AR
  'SPRED1':  '#6a1b9a',  // deep purple    — Legius; NF1 DDx; no tumours
  'SMARCE1': '#006064',  // dark cyan      — Spinal meningioma; young women; BAF57
  'PRKAR1A': '#4a148c',  // deep violet    — Carney complex; cardiac myxoma; PPNAD
  'AKT1':    '#1b5e20',  // forest green   — Proteus; CCTN; mosaic; DVT/PE
};

const GENE_INFO = {
  'NF1':     { full: 'NF Type 1 / Plexiform Neurofibromas / MPNST 8-13%',    locus: '17q11.2',  size: '2839 aa / 319 kDa',   inh: 'AD LOF' },
  'NF2':     { full: 'NF Type 2 / Bilateral VS PATHOGNOMONIC / Merlin',       locus: '22q12.2',  size: '595 aa / 69 kDa',     inh: 'AD LOF' },
  'SMARCB1': { full: 'Schwannomatosis-2 / AT/RT PATHOGNOMONIC / INI1-loss',   locus: '22q11.23', size: '385 aa / 47 kDa',     inh: 'AD LOF' },
  'LZTR1':   { full: 'Schwannomatosis-1 / Painful / Bidirectional AD or AR',  locus: '22q11.21', size: '827 aa / 92 kDa',     inh: 'AD/AR' },
  'SPRED1':  { full: 'Legius Syndrome / NF1-like WITHOUT Tumours / No Lisch', locus: '15q14',    size: '444 aa / 49 kDa',     inh: 'AD LOF' },
  'SMARCE1': { full: 'Multiple Spinal Meningioma / Young Women / Clear-Cell', locus: '17q21.2',  size: '411 aa / 47 kDa',     inh: 'AD LOF' },
  'PRKAR1A': { full: 'Carney Complex / Cardiac Myxoma 30% / PPNAD Cushing',   locus: '17q24.2',  size: '381 aa / 43 kDa',     inh: 'AD LOF' },
  'AKT1':    { full: 'Proteus Syndrome / CCTN PATHOGNOMONIC / Mosaic GOF',    locus: '14q32.33', size: '480 aa / 56 kDa',     inh: 'Somatic Mosaic GOF' },
};
...
export default function HereditaryNeurofibromatosisAtlas() {
  ...
  return (
    <div style={{ fontFamily: 'system-ui,sans-serif', background: '#0a0a0a', minHeight: '100vh', color: '#e8e8e8', padding: 24 }}>
      {/* Header */}
      <div style={{ background: 'linear-gradient(135deg,#1a0030 0%,#002060 60%,#004d00 100%)', borderRadius: 12, padding: '28px 32px', marginBottom: 24 }}>
        <div style={{ fontSize: 11, color: '#90caf9', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 8 }}>
          Hereditary Disease Atlas · NF &amp; Schwannomatosis · 8-Gene Reference
        </div>
        <h1 style={{ margin: 0, fontSize: 26, fontWeight: 800, color: '#fff' }}>
          🧬 Hereditary Neurofibromatosis &amp; Schwannomatosis Atlas
        </h1>
        <div style={{ marginTop: 10, color: '#b0bec5', fontSize: 13 }}>
          Complete 8-Gene Predisposition Reference · NF1 · NF2 · SMARCB1 · LZTR1 · SPRED1 · SMARCE1 · PRKAR1A · AKT1
        </div>
        ...
        <div style={{ marginTop: 10, fontSize: 11, color: '#80cbc4' }}>
          320-patient aggregate · 8 × 40 seeds · seeds 3110-3117 · NF1 1:3000 most-common AD · NF2 bilateral-VS-PATHOGNOMONIC · SMARCB1 AT/RT-PATHOGNOMONIC · LZTR1 bidirectional-AD/AR · SPRED1 Legius-NF1-DDx · SMARCE1 spinal-meningioma · PRKAR1A cardiac-myxoma-MANDATORY-echo · AKT1 Proteus-CCTN
        </div>
      </div>
      ...
      {tab === 'Overview' && overview && (
        <div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 16, marginBottom: 24 }}>
            {[
              ...
              <div key={label} style={{ background: '#1e1e1e', borderRadius: 8, padding: '18px 20px', textAlign: 'center' }}>
                <div style={{ fontSize: 28, fontWeight: 800, color: '#90caf9' }}>{val}</div>
          ...
          <div style={{ background: '#1e1e1e', borderRadius: 8, padding: 20, marginBottom: 16 }}>
            <h3 style={{ margin: '0 0 14px', color: '#90caf9', fontSize: 15 }}>⚠ Key Clinical Rules</h3>
              ...
              <div key={g.gene} style={{ background: '#1e1e1e', borderRadius: 8, marginBottom: 12, overflow: 'hidden', borderLeft: `4px solid ${color}` }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: 12, alignItems: 'center', fontSize: 12 }}>
                    ...
                    <span style={{ color: '#90caf9' }}>Age {g.mean_age_diagnosis}yr</span>
      ...
      {tab === 'Clinical Atlas' && breakdown && (
        <div>
          <div style={{ background: '#1e1e1e', borderRadius: 8, padding: 20, marginBottom: 20 }}>
            <h3 style={{ margin: '0 0 16px', color: '#90caf9', fontSize: 15 }}>Syndrome Summary — Neurofibromatosis &amp; Schwannomatosis</h3>
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
                <thead>
                  <tr style={{ background: '#111' }}>
                    {['Gene', 'Syndrome', 'Locus', 'Size', 'Inheritance', 'Pathognomonic', 'Key Therapy', 'n', 'Dx Age'].map(h => (
                      <th key={h} style={{ padding: '8px 10px', textAlign: 'left', color: '#90caf9', borderBottom: '1px solid #333', whiteSpace: 'nowrap' }}>{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  {breakdown.genes.map((g, idx) => {
                    ...
                    return (
                      <tr key={g.gene} style={{ background: idx % 2 === 0 ? '#181818' : '#1e1e1e' }}>
                        ...
                        <td style={{ padding: '8px 10px', color: '#90caf9' }}>{g.mean_age_diagnosis}yr</td>
                      </tr>
                    );
                  })}
                </tbody>
          ...
          <div style={{ background: '#1e1e1e', borderRadius: 8, padding: 20 }}>
            <h3 style={{ margin: '0 0 16px', color: '#90caf9', fontSize: 15 }}>Protein Size Reference</h3>
      ...
      {tab === 'Definitions' && definitions && (
        <div>
          <div style={{ marginBottom: 12, fontSize: 12, color: '#888' }}>
            {definitions.count} clinical definitions · NF1 surveillance · NF2 bevacizumab · SMARCB1 rhabdoid protocol · LZTR1 bidirectional inheritance · SPRED1 Legius DDx · SMARCE1 spinal meningioma · PRKAR1A Carney complex · AKT1 Proteus diagnosis · neurocutaneous differential guide
          </div>
          {definitions.definitions.map((d, i) => (
            <div key={i} style={{ background: '#1e1e1e', borderRadius: 8, marginBottom: 12, overflow: 'hidden' }}>
              <div style={{ background: '#1565c0', padding: '10px 16px', fontSize: 13, fontWeight: 700, color: '#fff' }}>
                {d.term.replace(/-/g, ' ')}
              </div>
