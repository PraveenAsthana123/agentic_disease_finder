...
const COLOR = '#1b5e20';   // deep forest green — PD-module 2-TM-helix ND4/ND5-boundary / CI-B18
const LIGHT = '#e8f5e9';
  ...
  return (
    <>
      <div className="row g-3 mb-4">
        ...
        <KPI label="Also known as"     value="CI-B18 / B18"              color={COLOR} />
      ...
      <SectionCard title="⚡ Key Pathway Note — PD-Module 2-TM-Helix ND4/ND5-Boundary Outer-Face Scaffold (CI-B18)">
      ...
      <SectionCard title="📊 Feature Frequencies (40-patient cohort, seed-671)">
...
function PatientsTab({ data }) {
  ...
  return (
    <>
      ...
      <SectionCard title="🗂 Patient Cohort (40 patients, seed-671)">
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function NDUFB7Page() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`${API}/api/ndufb7/overview`).then(r => r.json()),
      fetch(`${API}/api/ndufb7/breakdown`).then(r => r.json()),
      fetch(`${API}/api/ndufb7/definitions`).then(r => r.json()),
  ...
  return (
    <div className="container-fluid py-4">
      <div className="mb-4 p-3 rounded" style={{ background: COLOR, color: '#fff' }}>
        <h4 className="mb-1 fw-bold">&#x1f9ec; NDUFB7 — Leigh Syndrome Isolated Complex I Deficiency</h4>
        <div className="small opacity-90">
          CI-Leigh · PD-Module CI-B18 / B18 · 2-TM-Helix ND4/ND5-Boundary Outer-Face Scaffold ·
          14.8 kDa · 136aa precursor / 129aa mature · 19q13.42 · OMIM Gene *601825 · AR biallelic · Isolated CI 5–20% · CII/CIII/CIV NORMAL
        </div>
      </div>
