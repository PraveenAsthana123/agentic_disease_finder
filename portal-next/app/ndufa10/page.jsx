...
const COLOR = '#00695c';   // dark teal — NDP-kinase Rossmann fold / PINK1-Parkinson bridge
const LIGHT = '#e0f2f1';
  ...
  return (
    <>
      <div className="row g-3 mb-4">
        ...
        <KPI label="Also known as"     value="42kDa / NDP-kinase-like"  color={COLOR} />
      ...
      <SectionCard title="⚡ Key Pathway Note — PINK1-Parkinsonism Bridge">
      ...
      <SectionCard title="📊 Feature Frequencies (40-patient cohort, seed-639)">
...
function PatientsTab({ data }) {
  ...
  return (
    <>
      ...
      <SectionCard title="🗂 Patient Cohort (40 patients, seed-639)">
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function NDUFA10Page() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`${API}/api/ndufa10/overview`).then(r => r.json()),
      fetch(`${API}/api/ndufa10/breakdown`).then(r => r.json()),
      fetch(`${API}/api/ndufa10/definitions`).then(r => r.json()),
  ...
  return (
    <div className="container-fluid py-4">
      <div className="mb-4 p-3 rounded" style={{ background: COLOR, color: '#fff' }}>
        <h4 className="mb-1 fw-bold">&#x1f9ec; NDUFA10 — Leigh Syndrome Isolated Complex I Deficiency</h4>
        <div className="small opacity-90">
          CI-Leigh · NDP-Kinase-Like Rossmann-Fold Q-Module Peripheral Scaffold · PINK1-Phosphorylation-Target (Ser250) ·
          42kDa · 335aa precursor · 2q37.3 · OMIM Gene *603835 · AR biallelic · Isolated CI 5–20% · CII/CIII/CIV NORMAL
        </div>
      </div>
