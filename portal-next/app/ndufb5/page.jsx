...
const COLOR = '#1a237e';   // dark indigo — PP-module 0-TM-helix ND2/ND6-outer-face / CI-B16.6 / SGDH
const LIGHT = '#e8eaf6';
  ...
  return (
    <>
      <div className="row g-3 mb-4">
        ...
        <KPI label="Also known as"     value="CI-B16.6 / SGDH"           color={COLOR} />
      ...
      <SectionCard title="⚡ Key Pathway Note — PP-Module 0-TM-Helix SGDH-Fold ND2/ND6-Outer-Face Scaffold (CI-B16.6)">
      ...
      <SectionCard title="📊 Feature Frequencies (40-patient cohort, seed-669)">
...
function PatientsTab({ data }) {
  ...
  return (
    <>
      ...
      <SectionCard title="🗂 Patient Cohort (40 patients, seed-669)">
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function NDUFB5Page() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`${API}/api/ndufb5/overview`).then(r => r.json()),
      fetch(`${API}/api/ndufb5/breakdown`).then(r => r.json()),
      fetch(`${API}/api/ndufb5/definitions`).then(r => r.json()),
  ...
  return (
    <div className="container-fluid py-4">
      <div className="mb-4 p-3 rounded" style={{ background: COLOR, color: '#fff' }}>
        <h4 className="mb-1 fw-bold">&#x1f9ec; NDUFB5 — Leigh Syndrome Isolated Complex I Deficiency</h4>
        <div className="small opacity-90">
          CI-Leigh · PP-Module CI-B16.6 / SGDH · 0-TM-Helix ND2/ND6-Outer-Face Peripheral Scaffold ·
          16.6 kDa · 189aa precursor / 153aa mature · 3q26.33 · OMIM Gene *603847 · AR biallelic · Isolated CI 5–20% · CII/CIII/CIV NORMAL
        </div>
      </div>
