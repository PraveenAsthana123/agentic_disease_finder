...
export default function MODYPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`${API}/api/hereditary-mody-atlas/overview`).then(r => r.json()),
      fetch(`${API}/api/hereditary-mody-atlas/breakdown`).then(r => r.json()),
      fetch(`${API}/api/hereditary-mody-atlas/definitions`).then(r => r.json()),
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto' }}>
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ color: '#64748b', fontSize: 13 }}>
            Complete 8-Gene Hereditary MODY Atlas — HNF1A / GCK / HNF4A / HNF1B / ABCC8 / KCNJ11 / INS / PDX1 — 320 Patients (8×40, Seeds 1694–1701)
          </p>
        </div>
