...
const COLOR = '#1a237e';   // deep indigo-blue — PD-module ND4-face triad / B17 coiled-coil linker
const LIGHT = '#e8eaf6';
  ...
  return (
    <>
      <div className="row g-3 mb-4">
        ...
        <KPI label="Also known as"     value="B17 / PD-module"     color={COLOR} />
      ...
      <SectionCard title="⚡ Key Pathway Note — PD-Module ND4-Face Triad (NDUFB4-NDUFB6-NDUFB8)">
      ...
      <SectionCard title="📊 Feature Frequencies (40-patient cohort, seed-645)">
...
function PatientsTab({ data }) {
  ...
  return (
    <>
      ...
      <SectionCard title="🗂 Patient Cohort (40 patients, seed-645)">
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function NDUFB6Page() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`${API}/api/ndufb6/overview`).then(r => r.json()),
      fetch(`${API}/api/ndufb6/breakdown`).then(r => r.json()),
      fetch(`${API}/api/ndufb6/definitions`).then(r => r.json()),
  ...
  return (
    <div className="container-fluid py-4">
      <div className="mb-4 p-3 rounded" style={{ background: COLOR, color: '#fff' }}>
        <h4 className="mb-1 fw-bold">&#x1f9ec; NDUFB6 — Leigh Syndrome Isolated Complex I Deficiency</h4>
        <div className="small opacity-90">
          CI-Leigh · PD-Module B17 Coiled-Coil ND4-Face Triad Central Linker (NDUFB4-NDUFB6-NDUFB8) ·
          14.6 kDa · 128 aa · 9p21.1 · OMIM Gene *603879 · AR biallelic · Isolated CI 5–20% · CII/CIII/CIV NORMAL
        </div>
      </div>
