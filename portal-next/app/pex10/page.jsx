...
const ACCENT5 = '#4a148c';   // deep purple — molecular biology / PEX10 scaffold mechanism
...
function OverviewTab({ data }) {
  ...
  return (
    <div>
      ...
      />
      <Alert
        text={`ℹ PEX10 = SCAFFOLD/BRIDGE subunit of the PEX2–PEX10–PEX12 RING E3 ubiquitin ligase complex. Unlike PEX2 (one catalytic arm), PEX10 loss DESTABILIZES THE ENTIRE RING TRIMER — both PEX2 and PEX12 lose membrane association simultaneously. ~5–7% of all PBD-ZSD; ~80–120 cases worldwide 2026 (more common than PEX2 ~20–30). p.Ile332Thr partial-function allele → 25% IRD (vs 20% in PEX2). Biochemically identical to PEX1/PEX2/PEX6-ZSD — only NGS panel distinguishes.`}
        variant="info"
      />
      ...
      <SectionCard title="Disease Summary — PEX10 / Zellweger Spectrum Disorder (ZSD)" borderColor={ACCENT}>
      ...
      <div className="row">
        <div className="col-md-6">
          <SectionCard title="Clinical Profile" borderColor={ACCENT4}>
            ...
            <PctBar label="IRD (attenuated — Ile332Thr/mild)" pct={d.ird_pct} color={ACCENT} />
      ...
      <SectionCard title="PEX10 Scaffold Mechanism — Unique Role vs PEX2 and PEX12" borderColor={ACCENT5}>
        <div className="row small">
          <div className="col-md-4">
            <p className="fw-bold mb-1" style={{ color: ACCENT5 }}>PEX10 — Scaffold/Bridge</p>
            <ul className="mb-0">
              <li>Coiled-coil domain: tethers PEX2 ↔ PEX12</li>
              <li>N-TMD: membrane anchor</li>
              <li>RING finger: E3 catalytic activity</li>
              <li><strong>PEX10 LOF → ENTIRE TRIMER COLLAPSES</strong></li>
              <li>PEX2 + PEX12 both lose membrane support</li>
            </ul>
          </div>
          <div className="col-md-4">
            <p className="fw-bold mb-1" style={{ color: ACCENT4 }}>PEX2 — Catalytic Subunit</p>
            <ul className="mb-0">
              <li>RING finger: E3 catalytic arm</li>
              <li>PEX2 LOF = one catalytic arm fails</li>
              <li>PEX10–PEX12 scaffold partially preserved</li>
              <li>RING complex structurally partial (vs PEX10 LOF)</li>
            </ul>
          </div>
          <div className="col-md-4">
            <p className="fw-bold mb-1" style={{ color: ACCENT3 }}>Common Outcome (All 3 LOF)</p>
            <ul className="mb-0">
              <li>PEX5 cannot be ubiquitinated</li>
        ...
        <div className="mt-2 small">
          <Badge text="p.Ile332Thr" color={ACCENT5} /> Partial-function RING allele (~10–15% E3 residual) → enables IRD phenotype (25% IRD PEX10 vs 20% PEX2) when compound het with null allele.
        </div>
      </SectionCard>
...
function PatientsTab({ data }) {
  ...
  return (
    <div>
      <Alert
        text="ℹ ZSD SPECTRUM (PEX10): null/null → ZS (25%) · null/p.Ile332Thr → NALD (45%) · p.Ile332Thr/mild → IRD (25% — MORE than PEX2-ZSD 20%) · Atypical (5%). PEX10 has p.Ile332Thr partial-function RING allele enabling more IRD than PEX2. No founder hypomorphic allele → spectrum still skewed severe vs PEX1/PEX6. Biochemically identical to PEX1/PEX2/PEX6-ZSD; only NGS panel distinguishes."
        variant="info"
      />
      <h6 className="fw-bold mb-3" style={{ color: ACCENT }}>PEX10-ZSD Phenotypic Classes — 4 Classes (40 Patients)</h6>
      {etiologies?.map((e, i) => (
            ...
            <div className="row small">
              ...
              <div className="col-md-6">
                ...
                <div className="d-flex gap-2 flex-wrap mt-1">
                  ...
                  {!e.ert_available && <Badge text="No ERT (membrane scaffold)" color="#888" />}
                </div>
              </div>
            </div>
...
function DefinitionsTab({ data }) {
  ...
  return (
    <>
      ...
      <SectionCard title="Differential Diagnosis (vs PEX1/PEX2/PEX6/PEX12/ABCD1/PHYH/RCDP/Mito)" borderColor={ACCENT3}>
        <div className="table-responsive">
          <table className="table table-sm">
...
// ── Main Component ────────────────────────────────────────────────────────────
export default function PEX10Page() {
  ...
  useEffect(() => {
    if (tab >= 1 && tab <= 3) {
      fetch(`${API}/api/pex10/breakdown`).then(r => r.json()).then(setBreakdown).catch(() => {});
    }
    if (tab === 4) {
      fetch(`${API}/api/pex10/definitions`).then(r => r.json()).then(setDefinitions).catch(() => {});
    }
  }, [tab]);
    ...
    <div className="container-fluid py-4" style={{ maxWidth: 1200 }}>
      <div className="mb-4">
        <h2 className="fw-bold mb-1" style={{ color: ACCENT }}>
          PEX10 Epilepsy — Zellweger Spectrum Disorder (ZSD)
        </h2>
        <p className="text-muted small mb-2">
          PEX10 (1p36.32) · RING finger E3 ubiquitin ligase scaffold (337 aa) · PEX2–PEX10–PEX12 RING complex ·
          PEX10 = BRIDGE subunit — coiled-coil tethers PEX2 ↔ PEX12 · PEX10 LOF → entire trimer collapses ·
          AR biallelic LOF · p.Arg234* (most frequent null) · p.Ile332Thr (partial-function RING → IRD-enabling) ·
          ~5–7% of all PBD-ZSD · ~80–120 cases worldwide 2026 ·
          ZS 25% · NALD 45% · IRD 25% (MORE than PEX2 20% — p.Ile332Thr allele) ·
