...
const GENE_INFO = {
  ...
  CDKN2A: { full: "Cyclin-Dependent Kinase Inhibitor 2A (p16/INK4A)",         locus: "9p21.3",   size: "156 aa / 17 kDa",    inh: "AD LOF" },
  ATM:    { full: "Ataxia-Telangiectasia Mutated (PI3K-like kinase)",          locus: "11q22.3",  size: "3056 aa / 350 kDa",  inh: "AR+AD LOF" },
  PALB2:  { full: "Partner and Localiser of BRCA2 (WD40 scaffold)",           locus: "16p12.2",  size: "1186 aa / 131 kDa",  inh: "AD LOF" },
  ...
  PRSS1:  { full: "Cationic Trypsinogen (serine protease precursor)",          locus: "7q34",     size: "247 aa / 26 kDa",    inh: "AD GOF" },
};

export default function HereditaryPancreaticCancerPredispositionAtlasPage() {
  ...
  useEffect(() => {
    const base = "/api/hereditary-pancreatic-cancer-predisposition-atlas";
    Promise.all([
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 24, borderBottom: "2px solid #1a6b4a", paddingBottom: 16 }}>
          ...
          <div style={{ fontSize: 12, color: "#95a5a6", marginTop: 4 }}>
            Complete 8-Gene Reference · BRCA2-CDKN2A-ATM-PALB2-STK11-MLH1-TP53-PRSS1 ·{" "}
            320-Patient Aggregate (8×40, seeds 3342–3349)
          </div>
        </div>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11 }}>
              <thead>
                <tr style={{ background: "#1a1d2e", color: "#7f8c8d" }}>
                  {["Gene", "Full Name", "Locus", "Size", "Inheritance", "Syndrome", "PC Risk", "Key Rule"].map(h => (
                ...
                {breakdown?.genes?.map((g, i) => {
                  ...
                  return (
                    <tr key={g} style={{ background: i % 2 === 0 ? "#0f1117" : "#1a1d2e" }}>
                      ...
                      <td style={{ padding: "8px 10px", color: "#2ecc71", fontSize: 10 }}>{(bd?.pc_risk || "")?.substring(0, 55)}…</td>
        ...
        <div style={{ marginTop: 32, paddingTop: 16, borderTop: "1px solid #2c3e50", fontSize: 10, color: "#4a5568", textAlign: "center" }}>
          Hereditary Pancreatic Cancer Predisposition Atlas · 8-Gene Reference (BRCA2-CDKN2A-ATM-PALB2-STK11-MLH1-TP53-PRSS1) ·
          320 patients (8×40, seeds 3342–3349) · Agenticfinder Expert Dashboards
        </div>
      </div>
    </div>
  );
