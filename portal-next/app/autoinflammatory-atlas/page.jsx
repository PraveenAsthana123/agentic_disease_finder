...
const GENE_COLORS = {
  MEFV:     '#b71c1c',   // deep red — FMF / pyrin
  NLRP3:    '#880e4f',   // deep pink — CAPS / cryopyrin
  TNFRSF1A: '#4a148c',   // deep purple — TRAPS / TNFR1
  MVK:      '#1a237e',   // deep navy — MKD / mevalonate kinase
  IL1RN:    '#0d47a1',   // deep blue — DIRA / IL-1Ra
  CECR1:    '#006064',   // deep teal — DADA2 / ADA2
  NOD2:     '#1b5e20',   // deep green — Blau / NOD2
  PSMB8:    '#e65100',   // deep orange — PRAAS / immunoproteasome
};
...
function Loading() {
  return (
    <div className="text-center py-5">
      ...
      <p className="mt-3 text-muted">Loading autoinflammatory atlas…</p>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <div className="rounded-3 p-4 mb-4 text-white" style={{ background: 'linear-gradient(135deg,#b71c1c,#4a148c)' }}>
        <h3 className="mb-1">{ov.atlas_name || 'Autoinflammatory Atlas'}</h3>
      ...
      <div className="row mt-2">
        <div className="col-md-6">
          <div className="card border-0 shadow-sm mb-3">
            <div className="card-header fw-semibold" style={{ background: '#fce4ec' }}>Clinical Rates (Aggregate)</div>
        ...
        <div className="col-md-6">
          <div className="card border-0 shadow-sm mb-3">
            <div className="card-header fw-semibold" style={{ background: '#fce4ec' }}>Pathway Targets</div>
            <div className="card-body">
          ...
          <div className="card border-0 shadow-sm mb-3">
            <div className="card-header fw-semibold" style={{ background: '#fce4ec' }}>Severity Distribution</div>
            <div className="card-body">
      ...
      {ov.disease_category_breakdown && (
        <div className="card border-0 shadow-sm mb-3">
          <div className="card-header fw-semibold" style={{ background: '#fce4ec' }}>Disease Pathway Category Distribution</div>
          <div className="card-body">
...
function GeneTableTab({ data }) {
  ...
  return (
    <div>
      <h5 className="mb-3">8-Gene Hereditary Autoinflammatory Disorder Reference Table</h5>
    ...
    <div>
      ...
      {gene && (
        <div>
          ...
          <div className="card border-0 shadow-sm mb-3">
            <div className="card-header fw-semibold">Renal / Clinical Pattern</div>
            <div className="card-body small">
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-6">
                  ...
                  <BarRow label="Transplant/HSCT" pct={gene.cohort_stats?.transplant_pct}    color="#1b5e20" />
                </div>
                <div className="col-md-6">
...
function DefinitionsTab({ data }) {
  ...
  return (
    <div>
      <h5 className="mb-3">Clinical Definitions — Hereditary Autoinflammatory Disorder Terms</h5>
      {defs.map((d, i) => (
        <div key={i} className="card border-0 shadow-sm mb-3">
          <div className="card-header fw-bold" style={{ background: '#fce4ec' }}>
            {d.term}
...
export default function AutoinflammatoryAtlasPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`${API}/api/autoinflammatory-atlas/overview`).then(r => r.json()),
      fetch(`${API}/api/autoinflammatory-atlas/breakdown`).then(r => r.json()),
      fetch(`${API}/api/autoinflammatory-atlas/definitions`).then(r => r.json()),
    ])
      .then(([ov, bd, df]) => {
        setOverview(ov);
        setBreakdown(bd);
