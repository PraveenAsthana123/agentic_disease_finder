...
const SLUG = 'hereditary-biliary-cancer-predisposition-atlas';
const TABS = ['Overview', 'Gene Table', 'Clinical Atlas', 'Definitions'];

const GENE_COLORS = {
  'BAP1':   '#4a148c',  // deep purple     — TPDS; iCCA 40-50% HIGHEST; MBAITs PATHOGNOMONIC; AVOID ASBESTOS
  'BRCA1':  '#c62828',  // brick red       — HBOC; iCCA 2-4x; RRSO 35-40yr; olaparib
  'BRCA2':  '#1b5e20',  // deep green      — HBOC; biliary 3-4x; FA-D1; POLO paradigm; cisplatin HRD
  'ATM':    '#880e4f',  // deep magenta    — A-T; biliary 2-4x; RADIOSENSITIVITY ABSOLUTE; ceralasertib ATRi
  'MLH1':   '#0d47a1',  // deep blue       — Lynch1; bile-duct CCA 2-4x; MSI-H PATHOGNOMONIC; pembrolizumab FDA2017
  'MSH2':   '#004d40',  // deep teal       — Lynch2; urothelial 10-14% HIGHEST; Muir-Torre PATHOGNOMONIC; EPCAM
  'CDKN2A': '#006064',  // dark cyan       — FAMM; CCA 3-5x; palbociclib RESISTANCE; pancreatic 17-39%
  'STK11':  '#e65100',  // deep orange     — PJS; biliary polyps+CCA; pancreatic 11-36% HIGHEST; macules PATHOGNOMONIC; earliest 30yr
};

const GENE_INFO = {
  'BAP1':   { full: 'TPDS / iCCA-40-50%-LIFETIME-HIGHEST / MBAITs-Atypical-Spitz-PATHOGNOMONIC / Mesothelioma-30-60% / AVOID-ASBESTOS-ABSOLUTELY',       locus: '3p21.1',   size: '729 aa / 80 kDa',   inh: 'AD LOF' },
  'BRCA1':  { full: 'HBOC / iCCA-2-4x-RR / Gallbladder-2-3x / RRSO-35-40yr / Cisplatin-HRD-Preferred / Olaparib-PARP-Sensitive',                         locus: '17q21.31', size: '1863 aa / 208 kDa', inh: 'AD LOF' },
  'BRCA2':  { full: 'HBOC / Biliary-3-4x-STRONGEST-BRCA / FA-D1-Biallelic / Olaparib-POLO-Maintenance / Cisplatin-HRD-SBS3',                              locus: '13q12.3',  size: '3418 aa / 384 kDa', inh: 'AD LOF' },
  'ATM':    { full: 'A-T-Biallelic / Biliary-2-4x-Monoallelic / RADIOSENSITIVITY-ABSOLUTE-RT-Reduce-20-30% / Ceralasertib-ATRi-Synthetic-Lethality',      locus: '11q22.3',  size: '3056 aa / 350 kDa', inh: 'AD/AR LOF' },
  'MLH1':   { full: 'Lynch1 / Bile-Duct-CCA-2-4x-Dominant / MSI-H-PATHOGNOMONIC / Pembrolizumab-FDA2017-dMMR / Aspirin-CAPP2-50%-Reduction',              locus: '3p22.2',   size: '756 aa / 85 kDa',   inh: 'AD LOF' },
  'MSH2':   { full: 'Lynch2 / Urothelial-10-14%-HIGHEST / Muir-Torre-Sebaceous-Carcinoma-PATHOGNOMONIC / EPCAM-3prime-MLPA-MANDATORY',                     locus: '2p21',     size: '936 aa / 105 kDa',  inh: 'AD LOF' },
  'CDKN2A': { full: 'FAMM / CCA-3-5x / Pancreatic-17-39%-MANDATORY-EUS-40yr / Melanoma-25-36% / Palbociclib-RESISTANCE-p16-Null',                        locus: '9p21.3',   size: '156 aa / 16 kDa',   inh: 'AD LOF' },
  'STK11':  { full: 'PJS / Biliary-Polyps-CCA-Risk / Pancreatic-11-36%-HIGHEST / Perioral-Macules-PATHOGNOMONIC / EARLIEST-Surveillance-30yr',            locus: '19p13.3',  size: '433 aa / 48 kDa',   inh: 'AD LOF' },
};
...
export default function HereditaryBiliaryCancerPredispositionAtlas() {
  ...
  if (loading) return <div style={containerStyle}><p style={{ color: '#888' }}>Loading Hereditary Biliary Cancer Predisposition Atlas…</p></div>;
    ...
    <div style={containerStyle}>
      ...
      <div style={{ ...cardStyle, borderLeft: '4px solid #4a148c' }}>
        <h1 style={{ color: '#ce93d8', fontSize: 18, margin: '0 0 6px' }}>
          🧬 Hereditary Biliary Cancer Predisposition Atlas
        </h1>
        <div style={{ color: '#888', fontSize: 12 }}>
          Complete 8-Gene Reference · BAP1-BRCA1-BRCA2-ATM-MLH1-MSH2-CDKN2A-STK11
        ...
        <div style={{ marginTop: 8, fontSize: 11, color: '#aaa' }}>
          ...
          <Badge text="BAP1 AVOID-ASBESTOS-ABSOLUTELY" color="#4a148c" />
          <Badge text="STK11 EARLIEST surveillance 30yr" color="#e65100" />
          <Badge text="CDKN2A palbociclib RESISTANCE" color="#006064" />
          <Badge text="MLH1 MSI-H PATHOGNOMONIC" color="#0d47a1" />
        </div>
      </div>
            ...
            {definitions.definitions && definitions.definitions.map((d, i) => (
              <div key={i} style={{
                ...
                borderLeft: `3px solid ${
                  i === 0 ? '#4a148c' : i === 1 ? '#c62828' : i === 2 ? '#1b5e20' :
                  i === 3 ? '#880e4f' : i === 4 ? '#0d47a1' : i === 5 ? '#004d40' :
                  i === 6 ? '#006064' : i === 7 ? '#e65100' : '#555'
                }`,
                cursor: 'pointer',
              }}
