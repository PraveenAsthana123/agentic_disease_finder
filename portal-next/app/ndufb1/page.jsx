...
const COLOR = '#006064';   // dark cyan — PP-module matrix peripheral scaffold / CI-MNLL / no TM helix
const LIGHT = '#e0f7fa';
  ...
  return (
    <>
      <div className="row g-3 mb-4">
        ...
        <KPI label="Also known as"     value="CI-MNLL / PP-module"    color={COLOR} />
      ...
      <SectionCard title="⚡ Key Pathway Note — PP-Module Matrix Peripheral Scaffold (No TM Helix)">
      ...
      <SectionCard title="📊 Feature Frequencies (40-patient cohort, seed-665)">
...
function PatientsTab({ data }) {
  ...
  return (
    <>
      ...
      <SectionCard title="🗂 Patient Cohort (40 patients, seed-665)">
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function NDUFB1Page() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`${API}/api/ndufb1/overview`).then(r => r.json()),
      fetch(`${API}/api/ndufb1/breakdown`).then(r => r.json()),
      fetch(`${API}/api/ndufb1/definitions`).then(r => r.json()),
  ...
  return (
    <div className="container-fluid py-4">
      <div className="mb-4 p-3 rounded" style={{ background: COLOR, color: '#fff' }}>
        <h4 className="mb-1 fw-bold">&#x1f9ec; NDUFB1 — Leigh Syndrome Isolated Complex I Deficiency</h4>
        <div className="small opacity-90">
          CI-Leigh · PP-Module CI-MNLL Peripheral Matrix-Face Scaffold · No TM Helix · Smallest Nuclear CI Subunit ·
          6.4kDa · 56aa mature · 14q32.13 · OMIM Gene *603836 · AR biallelic · Isolated CI 5–20% · CII/CIII/CIV NORMAL
        </div>
      </div>
