...
const COLOR = '#303f9f';   // deep indigo — PP-module 2-TM-helix ND3-lateral-face / CI-B13.7
const LIGHT = '#e8eaf6';
  ...
  return (
    <>
      <div className="row g-3 mb-4">
        ...
        <KPI label="Also known as"     value="CI-B13.7 / PP-module"      color={COLOR} />
      ...
      <SectionCard title="⚡ Key Pathway Note — PP-Module 2-TM-Helix ND3-Lateral-Face Scaffold (CI-B13.7)">
      ...
      <SectionCard title="📊 Feature Frequencies (40-patient cohort, seed-667)">
...
function PatientsTab({ data }) {
  ...
  return (
    <>
      ...
      <SectionCard title="🗂 Patient Cohort (40 patients, seed-667)">
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function NDUFB2Page() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`${API}/api/ndufb2/overview`).then(r => r.json()),
      fetch(`${API}/api/ndufb2/breakdown`).then(r => r.json()),
      fetch(`${API}/api/ndufb2/definitions`).then(r => r.json()),
  ...
  return (
    <div className="container-fluid py-4">
      <div className="mb-4 p-3 rounded" style={{ background: COLOR, color: '#fff' }}>
        <h4 className="mb-1 fw-bold">&#x1f9ec; NDUFB2 — Leigh Syndrome Isolated Complex I Deficiency</h4>
        <div className="small opacity-90">
          CI-Leigh · PP-Module CI-B13.7 · 2-TM-Helix ND3-Lateral-Face Peripheral Scaffold ·
          10kDa · 87aa · 7p13 · OMIM Gene *603838 · AR biallelic · Isolated CI 5–20% · CII/CIII/CIV NORMAL
        </div>
      </div>
