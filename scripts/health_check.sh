...
apifail=0; apitot=0
for e in data-manager requests automation-status clinical-trust drift eeg-viz/presets model-performance expert-roles seizure-timeline patient-compare?a=EPAT001\&b=EPAT002 fairness conversation ot ot/fall-risk psychologist psychologist/depression-anxiety coordinator coordinator/kpi; do
  apitot=$((apitot+1))
