    ...
    const load = async () => {
      ...
      try {
        const [ov, hm, mel, mfcc, df] = await Promise.all([
          axios.get(`${API_URL}/api/librosa/overview`),
          axios.get(`${API_URL}/api/librosa/heatmap`),
          axios.get(`${API_URL}/api/librosa/mel-spectrogram`),
          axios.get(`${API_URL}/api/librosa/mfcc`),
          axios.get(`${API_URL}/api/librosa/definitions`)
        ])
        setOverview(ov.data)
        setHeatmap(hm.data)
        setMelData(mel.data)
