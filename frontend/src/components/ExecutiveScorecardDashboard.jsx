    ...
    const load = async () => {
      ...
      try {
        const [ov, br, df] = await Promise.all([
          axios.get(`${API_URL}/api/executive-scorecard/overview`),
          axios.get(`${API_URL}/api/executive-scorecard/breakdown`),
          axios.get(`${API_URL}/api/executive-scorecard/definitions`)
        ])
        setOverview(ov.data)
