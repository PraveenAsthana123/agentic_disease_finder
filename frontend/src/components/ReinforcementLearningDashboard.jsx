    ...
    const load = async () => {
      try {
        const [ov, bd, df] = await Promise.all([
          axios.get(`${API_URL}/reinforcement-learning/overview`),
          axios.get(`${API_URL}/reinforcement-learning/breakdown`),
          axios.get(`${API_URL}/reinforcement-learning/definitions`)
        ])
        setOverview(ov.data)
