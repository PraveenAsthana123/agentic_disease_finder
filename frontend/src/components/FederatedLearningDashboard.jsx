    ...
    const load = async () => {
      ...
      try {
        const [o, b, d] = await Promise.all([
          axios.get(`${API_URL}/api/federated-learning/overview`),
          axios.get(`${API_URL}/api/federated-learning/breakdown`),
          axios.get(`${API_URL}/api/federated-learning/definitions`)
        ])
        setOverview(o.data)
        setBreakdown(b.data)
