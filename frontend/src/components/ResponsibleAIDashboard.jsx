    ...
    const load = async () => {
      ...
      try {
        const [ov, br, df] = await Promise.all([
          axios.get(`${API_URL}/responsible-ai-dashboard/overview`),
          axios.get(`${API_URL}/responsible-ai-dashboard/breakdown`),
          axios.get(`${API_URL}/responsible-ai-dashboard/definitions`)
        ])
        setOverview(ov.data)
