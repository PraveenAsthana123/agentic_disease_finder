    ...
    const load = async () => {
      ...
      try {
        const [o, b, d] = await Promise.all([
          axios.get(`${API_URL}/gnn-electrode-connectivity/overview`),
          axios.get(`${API_URL}/gnn-electrode-connectivity/breakdown`),
          axios.get(`${API_URL}/gnn-electrode-connectivity/definitions`)
        ])
        setOverview(o.data)
        setBreakdown(b.data)
