...
export default function ExpertDashboardsCatalogDashboard() {
  ...
  useEffect(() => {
    Promise.all([
      axios.get(`${API_URL}/expert-dashboards-catalog/overview`),
      axios.get(`${API_URL}/expert-dashboards-catalog/breakdown`),
      axios.get(`${API_URL}/expert-dashboards-catalog/definitions`),
    ])
